...
internal sealed class InstrumentedAzureOpenAIClient : AzureOpenAIClient
{
    ...
    {
        return new InstrumentedAzureOpenAIClient(client, activitySource);
    }
    ...
    public override ChatClient GetChatClient(string deploymentName)
    {
        ...
        return InstrumentedChatClient.Create(chatClient, _activitySource, captureMessageContent: true);
    }
